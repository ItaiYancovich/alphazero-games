"""Ultimate Tic-Tac-Toe's rating table and player profiles.
...
Draws count, as they do in Connect Four: a drawn rated game scores half a point,
which is what :func:`record_result` takes here.
"""
...
RATINGS_PATH = ROOT / "runs" / "ratings_uttt.json"
USERS_PATH = ROOT / "runs" / "users_uttt.json"

STORE = RatingStore(RATINGS_PATH, USERS_PATH, game="uttt")
...
def record_result(name: str, opponent_key: str, opponent_rating: float,
    ...
    """Apply one rated Ultimate Tic-Tac-Toe game to a player's Elo.
