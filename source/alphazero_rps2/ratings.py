"""Intransitive's rating table and player profiles.
...
RATINGS_PATH = ROOT / "runs" / "ratings_rps2.json"
USERS_PATH = ROOT / "runs" / "users_rps2.json"

STORE = RatingStore(RATINGS_PATH, USERS_PATH, game="rps2")
...
def record_result(name: str, opponent_key: str, opponent_rating: float,
    ...
    """Apply one rated Intransitive game to a player's Elo.
